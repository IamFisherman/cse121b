...
function divideNumbers()
{
    ...
    let quotien = divide(dividend, divisor);
    document.getElementById("quotient").value = quotien;
}
...
let sumOfArray = numbers.reduce(getSum);
